...
using use = useUsing("use")`,
  ...
  [SkillNames.UNITY]: {
    ...
    name: "unity",
    label: "Unity",
    shortDescription: "Game dev engine, the chill pill for your 3D 🟢😌",
    color: "#000",
  ...
  [SkillNames.BLENDER]: {
    ...
    name: "blender",
    label: "Blender",
    shortDescription: "3D creation suite, the drama queen of meshes 👑📜",
    color: "#f5792a",
  ...
  [SkillNames.CPP]: {
    ...
    name: "cpp",
    label: "C++",
    shortDescription: "Utility classes but make it pointers, hitting different 🌪️🔥",
    color: "#00599C",
  ...
  [SkillNames.JUPYTER]: {
    ...
    name: "jupyter",
    label: "Jupyter",
    shortDescription: "Data science said 'sike, I'm analyzing now', deadass! 🔙🔚",
    color: "#F37626",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "AI and scripts go dummy hard, no cap! 🚂💨",
    color: "#3776AB",
  ...
  [SkillNames.EXCEL]: {
    ...
    name: "excel",
    label: "Excel",
    shortDescription: "Spreadsheets but make it fashion, purr 💅🐘",
    color: "#217346",
  ...
  [SkillNames.POWERBI]: {
    ...
    name: "powerbi",
    label: "Power BI",
    shortDescription: "Flexin' with that BI drip, respectfully! 💪🍃",
    color: "#F2C811",
  ...
  [SkillNames.FLASK]: {
    ...
    name: "flask",
    label: "Flask",
    shortDescription: "Microframework? In this economy? Ight, imma head out! 🚪🏃",
    color: "#000000",
